...
$password=$_POST['psd'];
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,Status,psd) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:status,:psd)";
...
$query->bindParam(':psd',$password,PDO::PARAM_STR);
$query->execute();
...
<div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="psd" class="col-sm-2 control-label">PASSWORD</label>
                                                        <div class="col-sm-10">
