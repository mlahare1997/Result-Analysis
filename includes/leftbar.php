<div class="left-sidebar bg-black-300 box-shadow ">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Student Programme</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="create-programme.php"><i class="fa fa-bars"></i> <span>Create Programme</span></a></li>
                                            <li><a href="manage-programme.php"><i class="fa fa fa-server"></i> <span>Manage Programme</span></a></li>
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-course.php"><i class="fa fa-bars"></i> <span>Create Courses</span></a></li>
                                            <li><a href="manage-course.php"><i class="fa fa fa-server"></i> <span>Manage Courses</span></a></li>
                                           <li><a href="add-coursecombination.php"><i class="fa fa-newspaper-o"></i> <span>Add Courses Combination </span></a></li>
                                           <a href="manage-coursecombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Courses Combination </span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
