...
<html lang="en">
    <head>
        ...
        <title>Faculty Subject Combination< </title>
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp; Sem-<?php echo htmlentities($result->ClassNameNumeric); ?> Section-<?php echo htmlentities($result->Section); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
...
foreach($results as $result)
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->SubjectCode); ?> <td> - <?php echo htmlentities($result->SubjectName); ?></td></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
