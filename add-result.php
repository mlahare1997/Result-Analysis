...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp; Sem-<?php echo htmlentities($result->ClassNameNumeric); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
<div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Course Code</label>
                                                        <div class="col-sm-10">
                                                    <div  id="subject">
                                                    </div>
                                                        </div>
