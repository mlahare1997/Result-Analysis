...
<html lang="en">
    <head>
        ...
        <title>SMS Faculty Subject Creation </title>
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Course Code" required="required">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Practical</label>
                                                        <div class="col-sm-10">
 <input type="radio" name="practical" class="btn btn-primary">Yes
 <input type="radio" name="practical" class="btn btn-primary" id="default" placeholder="Practical" required="required">NO
                                                        </div>
                                                    </div>
