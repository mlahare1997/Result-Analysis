...
?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                                        <a class="dashboard-stat bg-danger" href="manage-course.php">
<?php 
...
?>
                                            ...
                                            <span class="name">Course Listed</span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%;">
                                        <a class="dashboard-stat bg-warning" href="manage-programme.php">
                                        <?php 
...
?>
                                            ...
                                            <span class="name">Total Proggramme listed</span>
...
?>
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Welcome Admin to student Result Management System!");
